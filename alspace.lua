...
Onyx.Appearance = {
    ...
    Icon = "rbxassetid://122811888618431",
}
...
local MY_LOGO = "rbxassetid://122811888618431"
...
-- ============================================================
--  BACKEND (SEMUA DARI vidijembot.txt, TANPA UI)
-- ============================================================
-- SERVICES
...
SubESPStatus:AddToggle({
    ...
    Callback = function(v)
        ESPStatus.Enabled = v
        if not v then
            -- Hapus semua status ESP
            for _, billboard in pairs(ESPCache.Status) do
                if billboard and billboard.Parent then billboard:Destroy() end
            end
            ESPCache.Status = {}
            -- Hapus semua Item ESP
            for _, gui in pairs(ItemESP_Guis) do
                if gui and gui.Parent then gui:Destroy() end
            end
            ItemESP_Guis = {}
...
-- ====== CLEANUP FIXES (Player leave / character remove) ======
